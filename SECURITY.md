...
This tap does not clear `com.apple.quarantine` or otherwise bypass Gatekeeper. The personal Espresso, OneShot, and Shit casks are not part of the default Brewfile. Signed and notarized releases must pass Gatekeeper normally; unsigned releases require explicit macOS approval after installation.
